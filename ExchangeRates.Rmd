...
p <- ggplot(data=currency, aes(x=observation_date, y=UK)) +
  ...
  labs(title = "Exchange rates during Brexit", subtitle = "How many U.S. dollars £1 or €1 buys", y= " ", x = "Date", caption = "Source: St. Louis Federal Reserve. Created by: Sarah Gillespie") +
  expand_limits(y = 0) +
...
q <- ggplot(data=molten.meltedGDP2, aes(x=variable, y=value, group = Country, color=Country)) +
    ...
    geom_point() +
  scale_y_continuous(labels = dollar) +
    labs(title = "Gross Domestic Product", subtitle = "(in trillions of 2018 dollars)", y= " ", x = "Year", color = " ", caption = "Sources: World Bank, Bureau of Economic Analysis. Created by: Sarah Gillespie") +
  theme_bw()
