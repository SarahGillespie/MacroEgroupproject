...
p <- ggplot(data=currency, aes(x=observation_date, y=UK)) +
  ...
  labs(title = "Exchange rates during Brexit", subtitle = "How many U.S. dollars £1 or €1 buys", y= " ", x = "Date", caption = "Source: St. Louis Federal Reserve. Graph: Sarah Gillespie") +
  expand_limits(y = 0) +
